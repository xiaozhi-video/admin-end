		...
		children: [
			...
			},
			{
				...
				meta: {
					...
					icon: 'fa fa-sellsy',
					isKeepAlive: true,
					roles: ['superAdmin', 'homeRecommend', 'homeRotation']
				},
				children: [
					{
					...
					{
						path: '/operation/homeRotation',
						name: 'homeRotation',
						component: () => import('/@/views/operation/homeRotation/index.vue'),
						meta: {
							title: 'message.router.operationHomeRotation',
							isKeepAlive: true,
							roles: ['homeRotation'],
							icon: 'fa fa-retweet',
						},
